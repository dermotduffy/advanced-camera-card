...
| Option             | Default                                     | Description                                                                                                                                                                                                                                                                                                |
| ------------------ | ------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `channel`          | autodetected (direct), or `0` (via NVR/Hub) | The channel number for the Reolink camera. For cameras directly connected to Home Assistant, this value will be autodetected and need not be set. For cameras connected via a Hub/NVR, this value cannot currently be autodetected by dashboard cards -- a default value of `0` will be used in this case. |
...
?> If media for the "wrong" Reolink camera is showing up and you have an NVR camera, your `channel` value is likely incorrect. Try increasing it until you find the correct camera.
